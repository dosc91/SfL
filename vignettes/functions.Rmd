...
This vignette gives an overview of functions included in the `SfL` package. Please refer to the [data set vignette](#todo) for an overview of included data sets.
